...
class Runner(object):
    ...
    def load_data(self):
        ...
        print('{}_{} num is {}'.format('valii', 'head', len(self.triples['{}_{}'.format('valid', 'head')])))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_dim', default=200, type=int,
                        help='Initial dimension size for entities and relations')
    parser.add_argument('--gcn_dim', default=200, type=int, help='Number of hidden units in GCN')
    parser.add_argument('--embed_dim', default=200, type=int, help='Embedding dimension to give as input to score function')
    ...
    parser.add_argument('--mi_train', action='store_true', default=True, help='whether to disentangle')

    parser.add_argument('--early_stop', default=500, type=int, help="number of early_stop")
    ...
    parser.add_argument('--no_act', action='store_true', help='whether to use non_linear function')
    parser.add_argument('--no_enc', action='store_true', help='whether to use non_linear function')
    ...
    parser.add_argument('--score_method', default='dot_rel',
    ...
    parser.add_argument('--fix_gamma', action='store_true', help='whether to use non_linear function')
    parser.add_argument('--init_gamma', type=float, default=12.0, help='Margin')
    parser.add_argument('--gamma_method', default='norm', help='Composition Operation to be used in RAGAT')
