...
# python run_nodisen.py --DATASET Wiki --hidden_layers d100,d --embed_dim 50 --ep_dim 100 --input_dim 300 --sim_threshold
# python run_nodisen.py --DATASET Wiki --hidden_layers d100,d --embed_dim 50 --ep_dim 100 --sim_threshold
