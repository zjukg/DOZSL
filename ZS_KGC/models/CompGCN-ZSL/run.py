...
class Runner:
    def __init__(self, args):
        ...
        # prepare graph
        self.edge_index, self.edge_type, self.node2id, num_node, num_meta_rel = build_graph(args)

        self.args.num_node = num_node
        self.args.num_meta_rel = num_meta_rel

        print("Loading Training Data ... ")
        fc_vectors = self.prepare_train_data()
        self.train_idx = [self.node2id[rel] for rel in self.seen_rels]
        self.test_idx = [self.node2id[rel] for rel in self.unseen_rels]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dim", type=int, default=200, help="dimension of input")
    parser.add_argument("--hidden_dim", type=int, default=200, help="Number of hidden units")
    parser.add_argument("--output_dim", type=int, default=200, help="")
