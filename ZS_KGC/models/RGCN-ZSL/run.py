...
from util import row_normalize, build_graph
...
class Runner:
    def __init__(self, args):
        ...
        # val_tasks = json.load(open(os.path.join(args.DATA_DIR, args.DATASET, 'datasplit', "dev_tasks.json")))
        ...
        # prepare graph
        self.nodes_dict, self.A = build_graph(args)

        print("Loading Training Data ... ")
        fc_vectors, train_idx = self.prepare_train_data()
        self.train_idx = train_idx
        print("Loading Test Set ... ")
        test_idx = [self.nodes_dict[query] for query in sorted(list(self.test_tasks.keys()))]
    ...
    def prepare_train_data(self):
        ...
        train_idx = []
        for query in sorted(list(self.train_tasks.keys())):
            train_idx.append(self.nodes_dict[query])
    ...
    def test(self, pred_vectors):
        ...
        for i, query_ in enumerate(sorted(list(self.test_tasks.keys()))):
